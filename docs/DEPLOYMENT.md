...
| «password authentication failed» یا `P1000` | `DATABASE_URL` هنوز مقدار نمونه را دارد | در `.env` رمز و کاربر واقعی PostgreSQL را بگذارید؛ رمز دارای نویسه ویژه باید رمزگذاری شود |
